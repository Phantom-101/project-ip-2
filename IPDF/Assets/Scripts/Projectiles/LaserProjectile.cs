...
public class LaserProjectile : Projectile {
    ...
    public override void Initialize () {
        ...
        beam.visualEffectAsset = (turret as LaserTurret).asset;
        beam.SetGradient ("gradient", (turret as LaserTurret).beamGradient);
        beam.SetFloat ("size", (turret as LaserTurret).beamWidth);
    ...
    protected override void Process () {
        ...
        if (Physics.Raycast (beamFrom, to.transform.position - beamFrom, out hit, turret.range)) {
            ...
            beam.SetFloat ("count", hit.distance * 2000 / (turret as LaserTurret).beamWidth);
